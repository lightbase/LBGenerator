...
class CustomContextFactory(SQLAlchemyORMContext, CacheMaster):
    ...
    def get_collection(self, query):
        ...
        # NOTE: Seta a query na instância da classe! By John Doe
        self._query=query

        # NOTE: Instanciate the query compiler! By John Doe
        compiler=JsonQuery(self, **query)

        # NOTE: Build query as SQL! By John Doe
        ...
        # NOTE: Impede a explosão infinita de cláusula over! By Edu Santos
        if factory is None:
        ...
        # herda funcionalidades do SQLAlchemy! By John Doe
        ...
        # NOTE: Caso não seja localizado nenhum registro! By John Doe
